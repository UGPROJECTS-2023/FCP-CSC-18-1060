...
?>
		...
		<div class="containter-fluid">
			<div class="row">
                ...
                <div class="well"><h4><?php echo $row['suv_name'];?> &nbsp; <span class="pull-right"><a href="view_survey.php?cid=<?php echo $cid ?> &sid=<?php echo $sid?>" target="_blank">View Survey</a></span></h4> 
                </div>
